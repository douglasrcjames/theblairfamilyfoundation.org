...
var topBgImageStyle = {
    width: "100%",
    height: "300px",
    backgroundImage: `url(${require("../../assets/images/misc/grass.jpg")})`,
    backgroundPosition: "50% 20%", // change me around to move up and down!
    ...
    render() {
        return (
            ...
            <Grid fluid className="wrapper-w-img">
                <Row middle="xs">
                    <Col md={12} lg={8}>
                        <h1>Committed to our Environment</h1>
                        <p>
                        ...
                        <img
                            ...
                            alt="creek"
                            src={require("../../assets/images/misc/sunflowers.jpg")} />
                    </Col>
